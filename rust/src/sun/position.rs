...
fn variation_geocentric_longitude(jd: f64) -> ArcSec {
    ...
    let delta_lambda = 3548.193
        + 118.568 * Radians::from(Degrees::new(87.5287 + 359993.7286 * tau)).0.sin()
        + 2.476 * Radians::from(Degrees::new(85.0561 + 719987.4571 * tau)).0.sin()
        + 1.376 * Radians::from(Degrees::new(27.8502 + 4452671.1152 * tau)).0.sin()
        + 0.119 * Radians::from(Degrees::new(73.1375 + 450368.8564 * tau)).0.sin()
        + 0.114 * Radians::from(Degrees::new(337.2264 + 329644.6718 * tau)).0.sin()
        + 0.086 * Radians::from(Degrees::new(222.5400 + 659289.3436 * tau)).0.sin()
        + 0.078 * Radians::from(Degrees::new(162.8136 + 9224659.7915 * tau)).0.sin()
        + 0.054 * Radians::from(Degrees::new(82.5823 + 1079981.1857 * tau)).0.sin()
        + 0.052 * Radians::from(Degrees::new(171.5189 + 225184.4282 * tau)).0.sin()
        + 0.034 * Radians::from(Degrees::new(30.3214 + 4092677.3866 * tau)).0.sin()
        + 0.033 * Radians::from(Degrees::new(119.8105 + 337181.4711 * tau)).0.sin()
        + 0.023 * Radians::from(Degrees::new(247.5418 + 299295.6151 * tau)).0.sin()
        + 0.023 * Radians::from(Degrees::new(325.1526 + 315559.5560 * tau)).0.sin()
        + 0.021 * Radians::from(Degrees::new(155.1241 + 675553.2846 * tau)).0.sin()
        + 7.311 * tau * Radians::from(Degrees::new(333.4515 + 359993.7286 * tau)).0.sin()
        + 0.305 * tau * Radians::from(Degrees::new(330.9814 + 719987.4571 * tau)).0.sin()
        + 0.010 * tau * Radians::from(Degrees::new(328.5170 + 1079981.1857 * tau)).0.sin()
        + 0.309 * tau2 * Radians::from(Degrees::new(241.4518 + 359993.7286 * tau)).0.sin()
        + 0.021 * tau2 * Radians::from(Degrees::new(205.0482 + 719987.4571 * tau)).0.sin()
        + 0.004 * tau2 * Radians::from(Degrees::new(297.8610 + 4452671.1152 * tau)).0.sin()
        + 0.010 * tau3 * Radians::from(Degrees::new(154.7066 + 359993.7286 * tau)).0.sin();
